        ...
        <tr style="height: 20px">
            ...
            <td style="width: 100px;">
                <div class="rating" style="float: left; text-align: center">
                    ...
                    <div class="rating">
                        <span id="star1"><i class="rating4 fa fa-star"></i></span><span id="star2"><i class="rating4 fa fa-star"></i></span><span id="star3"><i class="rating4 fa fa-star"></i></span><span id="star4"><i class="rating4 fa fa-star"></i></span><span id="star5"><i class="rating4 fa fa-star"></i></span>
                    </div>
