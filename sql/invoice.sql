...
--
-- Host: 127.0.0.1
-- Gegenereerd op: 02 dec 2019 om 15:29
...
INSERT INTO `invoice` (`InvoicesID`, `PersonID`, `InvoiceDate`) VALUES
...
--
ALTER TABLE `invoice`
  MODIFY `InvoicesID` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=10;
